...
const baseEnv = {
  ...
  INVOKE_PROVIDERS_REGISTRY_URL: process.env.INVOKE_PROVIDERS_REGISTRY_URL ?? "http://127.0.0.1:5181",
  INVOKE_PROVIDERS_PROFILE: process.env.INVOKE_PROVIDERS_PROFILE ?? "local-dev",
  INVOKE_PROVIDERS_COMMIT_SHA: process.env.INVOKE_PROVIDERS_COMMIT_SHA ?? "dev",
